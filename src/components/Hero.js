      ...
      <div className="flex w-full flex-col items-center lg:flex-row px-4 py-4  lg:justify-start
        ...
        <motion.div
          ...
          >
            ...
            <p className='md:pl-20 text-md'>I'm a web developer enthusiast. Always seeking for a new experience through a case study to solve a problem. Also, learning a new thing like latest popular framework is fun for me</p>

            <div className='flex md:pl-20 gap-6 mt-2'>
